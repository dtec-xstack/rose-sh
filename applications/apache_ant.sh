: ${APACHE_ANT_DEPENDENCIES:=apache_ant ss_ant_rose}
: ${APACHE_ANT_CONFIGURE_OPTIONS:=
...
#-------------------------------------------------------------------------------
install_deps_apache_ant()
#-------------------------------------------------------------------------------
{
  install_deps ${APACHE_ANT_DEPENDENCIES} || fail "Could not install dependencies"
}
