: ${APACHE_JAMES_DEPENDENCIES:=apache_ant ss_ant_rose}
: ${APACHE_JAMES_CONFIGURE_OPTIONS:=
...
: ${APACHE_JAMES_ANT_TARGET:=compile}

#-------------------------------------------------------------------------------
download_apache_james()
#-------------------------------------------------------------------------------
{
...
#-------------------------------------------------------------------------------
install_deps_apache_james()
#-------------------------------------------------------------------------------
{
  install_deps ${APACHE_JAMES_DEPENDENCIES} || fail "Could not install dependencies"
}
